...
namespace EfCore_StoredProcedure
{
    public class SqlDbContext:DbContext
    {
        ...
        [NotMapped]
        public DbSet<KategoriVeUrunler> kategoriVeUrunler { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Urun>()
             ...
             modelBuilder.Entity<KategoriVeUrunler>().HasNoKey();
            ...
            modelBuilder.Entity<Urun>()
                ...
                new Urun { Id = 4, UrunAdi = "Karpuz", KategoriId = 1 },
                  new Urun { Id = 5, UrunAdi = "Gazoz", KategoriId = 2 },
                new Urun { Id = 6, UrunAdi = "Sari Gazoz", KategoriId = 2 },
                new Urun { Id = 7, UrunAdi = "KAra gazoz", KategoriId = 2 });
