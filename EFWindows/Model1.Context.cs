...
namespace EFWindows
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int CalisanEkle(string ad, string soyad, string sehir, ObjectParameter empId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CalisanEkle", adParameter, soyadParameter, sehirParameter, empId);
        }
